...
getgenv().Aiming = {
    ...
    Selected = nil,
    SelectedPart = nil,
    TargetPart = {"Head", "LowerTorso", "UpperTorso", "RightShoulder", "LeftShoulder", "LeftLowerArm", "RightLowerArm", "HumandoidRootPart" "RightHand", "LeftHand",},
...
local CalcChance = function(percentage)
    ...
    -- // Get the chance
    local chance = mathfloor(Randomnew().NextNumber(Randomnew(), 0, 1) * 105) / 105

    -- // Return
    return chance <= percentage / 105
end
